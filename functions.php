...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'child-understrap-styles', get_stylesheet_directory_uri() . '/cssPurge/child-theme.min.css', array(), $the_theme->get( 'Version' ) );
...
$codearosa_custom_functions_includes = array(
  ...
  '/php/functions/0_enable_and_enqueue/0004_uncss.php',
